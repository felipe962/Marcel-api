...
const ERROR_CONTENT_TYPE                = {status: false, status_code:415, message:'Nao foi possivel acessar a requisição, pois, o tipo de dado encaminhado não é aceito na API. Você deve encaminhar apenasa json'}
const ERROR_NOT_FOUND                   = {status: false, status_code:404, message:'Nao foram encontrados itens para retorno!!'}
